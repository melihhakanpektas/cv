...
Future<void> printPDF() async {
  final pdf = await rootBundle.load('assets/pdfs/melihhakanpektascv.pdf');
  Printing.layoutPdf(
      format: PdfPageFormat.a4,
      name: 'melihhakanpektas.pdf',
      dynamicLayout: false,
      onLayout: (PdfPageFormat format) => pdf.buffer.asUint8List());
}
...
Moreover, my passion for **music** has often intersected with my professional endeavors. Currently, I am immersed in a project focused on processing and visualizing live sound data by applying various algorithms to convert it into frequency data.""";
...
class _MainAppState extends State<MainApp> {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildPage1(width, height),
                          const SizedBox(height: 25),
                          _buildPage2(width, height),
                          const SizedBox(height: 25),
                        ],
                      ),
                    ),
  ...
  Widget _buildPage2(double width, double height) {
    return SelectionArea(
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              const Text('Projects (individually developed)', style: TextStyle(fontSize: 20)),
              ...
              _buildCertificate(
                title: 'Google Game & Application Academy Graduation Certificate 2023 (Flutter)',
                description:
  ...
  Widget _buildPage1(double width, double height) {
    return SelectionArea(
      child: Stack(
        children: [
          Container(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  launchUrl(Uri.parse('mailto:contact@melihhakanpektas.com'));
                                },
                                child: const Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  launchUrl(Uri.parse('https://www.melihhakanpektas.com'));
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildSkillBar('Third-party Libraries and APIs Integration', .9),
                              ...
                              const Wrap(
                                ...
                                children: [
                                  Chip(
                                      ...
                                      label: Text('Music', style: TextStyle(fontSize: 10))),
                                  Chip(
                                      padding: EdgeInsets.zero,
                                      label: Text('Guitar', style: TextStyle(fontSize: 10))),
                                  Chip(
                                      padding: EdgeInsets.zero,
                                      label: Text('Piano', style: TextStyle(fontSize: 10))),
                                ],
                              )
                            ],
                          ),
          ...
          Positioned(
            top: 10,
            left: 10,
            child: Image.asset('assets/images/siteqr.jpg', width: 50, height: 50),
          )
        ],
      ),
    );
  ...
  _buildPrintButton({required Null Function() onPressed}) {
    return Positioned(
      top: 20,
      right: 20,
